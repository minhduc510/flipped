...
const ratings = [
  ...
  { id: "hard", label: "Khó", hint: "Ôn lại ngày mai", className: "warning" },
  {
    id: "good",
    label: "Nhớ",
    hint: "Tăng khoảng cách ôn",
    className: "success",
  },
  {
    id: "easy",
    label: "Dễ",
    hint: "Đưa vào nhóm đã vững",
    className: "primary",
  },
];
...
export default function ReviewPage() {
  ...
  return (
    <section className="feature-page">
      <Helmet>
        <title>Ôn Tập Từ Vựng SRS | Flipped Song Ngữ</title>
        <meta
          name="description"
      ...
      <div className="stat-strip">
        ...
        <article>
          <strong>
            {chapterCards.filter((card) => card.status === "mastered").length}
          </strong>
          <span>Đã vững</span>
        </article>
      </div>
      ...
      {currentCard ? (
        <div className="review-stage">
          <article className={`flashcard ${showAnswer ? "revealed" : ""}`}>
            ...
            {currentCard.ipa && (
              <p className="flashcard-ipa">{currentCard.ipa}</p>
            )}
            ...
            {showAnswer ? (
              <div className="flashcard-answer">
                ...
                {currentCard.example &&
                  currentCard.example !== currentCard.context && (
